...
export function getPlatformLink(response: SongLinkResponse, platformApiKey: string): SongLinkPlatformLink | null {
  return response.linksByPlatform[platformApiKey] || null;
}
